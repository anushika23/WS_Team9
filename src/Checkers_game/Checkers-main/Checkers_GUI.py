...
class Menu(Frame):
    ...
    def __init__(self):
        ...
        self.button1 = Button(self.menuFrame, text="Play!", font=(  "Lucida Handwriting", "15", "bold"), width=13, height=2,
                              bg='purple',fg='white',command=board.start_game , relief=RIDGE,)
        self.button1.pack()
        self.button2 = Button(self.menuFrame, text="Settings", font=("Lucida Handwriting", "15", "bold"), width=13, height=2,
                              bg='purple',fg='white',command=board.show_settings, relief=RIDGE,)
        self.button2.pack()
        self.button3 = Button(self.menuFrame, text="Highscore", font=("Lucida Handwriting", "15", "bold"), width=13, height=2,
                              bg='purple',fg='white',command=board.show_high_score, relief=RIDGE,)
        self.button3.pack()
        self.button4 = Button(self.menuFrame, text="Exit", font=("Lucida Handwriting", "15", "bold"), width=13, height=2,
                            bg='purple',fg='white',  command=board.game_exit, cursor="pirate", relief=RIDGE,)
        self.button4.pack()
...
class Board(Tk):
    ...
    def __init__(self, width=700, height=700, cell_size=70):
        ...
        self.canvas.pack(expand=1, side=RIGHT,pady=60)

        self.textFrame = Frame(width=200, height=20)
        self.textFrame.pack(expand=1, fill=BOTH, side=RIGHT)
        self.textForUser = Text(self.textFrame, width=20, height=4, bg="white",fg='#cc3b3b', font=("Algerian", "28",'bold'),borderwidth=0,       wrap=WORD)
    ...
    def highlight_jump_piece(self):
        ...
        red_king = PhotoImage(file="red_king_hi.gif")
        black_king = PhotoImage(file="black_king_high.gif")
